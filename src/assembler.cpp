/* Generated by re2c 2.0.3 on Wed Oct  7 23:25:12 2020 */
...
#line 492 "assembler.yy"
	{ TOKEN(BYTE); }
#line 11773 "assembler.cpp"
yy319:
	do { ctx.in.ignore(); if (ctx.in.eof()) TOKEN(END_OF_FILE); } while(0);
#line 490 "assembler.yy"
	{ TOKEN(DATA); }
#line 11778 "assembler.cpp"
yy321:
	do { ctx.in.ignore(); if (ctx.in.eof()) TOKEN(END_OF_FILE); } while(0);
	yych = ctx.in.peek();
	switch (yych) {
...
#line 489 "assembler.yy"
	{ TOKEN(TEXT); }
#line 11790 "assembler.cpp"
yy324:
	do { ctx.in.ignore(); if (ctx.in.eof()) TOKEN(END_OF_FILE); } while(0);
#line 491 "assembler.yy"
	{ TOKEN(WORD); }
#line 11795 "assembler.cpp"
yy326:
	do { ctx.in.ignore(); if (ctx.in.eof()) TOKEN(END_OF_FILE); } while(0);
	yych = ctx.in.peek();
	switch (yych) {
...
#line 493 "assembler.yy"
	{ TOKEN(ASCII); }
#line 12079 "assembler.cpp"
yy343:
	do { ctx.in.ignore(); if (ctx.in.eof()) TOKEN(END_OF_FILE); } while(0);
#line 496 "assembler.yy"
	{ TOKEN(SPACE); }
#line 12084 "assembler.cpp"
yy345:
	do { ctx.in.ignore(); if (ctx.in.eof()) TOKEN(END_OF_FILE); } while(0);
	yych = ctx.in.peek();
	switch (yych) {
...
#line 511 "assembler.yy"
	{ TOKEN(BLTZAL); }
#line 12237 "assembler.cpp"
yy350:
	do { ctx.in.ignore(); if (ctx.in.eof()) TOKEN(END_OF_FILE); } while(0);
#line 494 "assembler.yy"
	{ TOKEN(ASCIIZ); }
#line 12242 "assembler.cpp"
}
