/* Generated by re2c 1.2.1 on Tue Oct 06 14:13:58 2020 */
...
#define tokenv(name, ...) { walk(); return parser::make_##name(__VA_ARGS__, ctx.loc); }
    #line 414 "assembler.yy"

init:
	
#line 4570 "assembler.cpp"
{
	char yych;
...
#line 421 "assembler.yy"
	{ token(BYTE); }
#line 11322 "assembler.cpp"
yy304:
	++ctx.cursor;
#line 419 "assembler.yy"
	{ token(DATA); }
#line 11327 "assembler.cpp"
yy306:
	yych = *++ctx.cursor;
	switch (yych) {
	case 'E':	goto yy328;
...
#line 422 "assembler.yy"
	{ token(ASCII); }
#line 11616 "assembler.cpp"
yy328:
	++ctx.cursor;
#line 425 "assembler.yy"
	{ token(SPACE); }
#line 11621 "assembler.cpp"
yy330:
	yych = *++ctx.cursor;
	switch (yych) {
	case 'z':	goto yy335;
