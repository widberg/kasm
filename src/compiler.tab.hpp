...
/**
 ** \file compiler.tab.hpp
 ** Define the  cyy ::parser class.
 */
...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    union union_type
    {
      ...
      // identifier
      // literal
      char dummy1[sizeof (kasm::ast::Node*)];

      // TYPE
      char dummy2[sizeof (kasm::ast::Type)];
      ...
      // LITERAL
      char dummy4[sizeof (std::uint32_t)];
    };
...
#endif
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, kasm::ast::Node*&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const kasm::ast::Node*& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
#endif
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, kasm::ast::Type&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const kasm::ast::Type& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
switch (yytype)
    ...
    struct symbol_type : basic_symbol<by_type>
    {
      ...
      {
        YYASSERT (tok == token::END_OF_FILE || tok == token::RETURN || tok == token::INCLUDE || tok == 44 || tok == 43 || tok == 45 || tok == 42 || tok == 47 || tok == 64 || tok == 126 || tok == 59 || tok == 61 || tok == 40 || tok == 41 || tok == 58 || tok == 123 || tok == 125);
      }
#else
...
#endif
#if 201103L <= YY_CPLUSPLUS
      symbol_type (int tok, kasm::ast::Type v, location_type l)
        : super_type(token_type (tok), std::move (v), std::move (l))
      {
        YYASSERT (tok == token::TYPE);
      }
#else
      symbol_type (int tok, const kasm::ast::Type& v, const location_type& l)
    ...
    parser (kasm::Compiler& compiler_yyarg);
    virtual ~parser ();
    ...
    // Implementation of make_symbol for each symbol type.
      ...
      static
      symbol_type
      make_TYPE (kasm::ast::Type v, location_type l)
      {
      ...
      static
      symbol_type
      make_TYPE (const kasm::ast::Type& v, const location_type& l)
      {
  ...
  parser::yytranslate_ (token_type t)
  {
    ...
    translate_table[] =
    {
       ...
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
      18,    19,    12,    10,     9,    11,     2,    13,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,    20,    16,
       2,    17,     2,     2,    14,     2,     2,     2,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
       2,     2,     2,    21,     2,    22,    15,     2,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
  ...
  parser::by_type::token () const YY_NOEXCEPT
  {
    ...
    yytoken_number_[] =
    {
      ...
      43,    45,    42,    47,    64,   126,    59,    61,    40,    41,
      58,   123,   125
    };
